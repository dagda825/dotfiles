...
theme.bg_focus      = "#beafc2"--"#e2eeea"
theme.bg_normal     = "#8155ba" --"#729fcf"
theme.bg_urgent     = "#fce94f"
theme.bg_minimize   = "#0067ce"
theme.bg_systray    = theme.bg_normal

theme.fg_normal     = "#eae7fa" --"#2e3436"
theme.fg_focus      = "#695e99" --"#2e3436"
...
-- MISC
theme.wallpaper             = "/home/jon/Pictures/wallpapers/0166.jpg" --themes_path .. "sky/sky-background.png"
